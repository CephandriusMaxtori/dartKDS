...
class DiscoveryService {
  ...
  Future<void> _announceLoop() async {
    ...
    // Adaptive backoff: start at 2s, slowly increase to 30s to save battery/bandwidth
    if (_currentInterval < const Duration(seconds: 30)) {
      _currentInterval += const Duration(seconds: 2);
    }

    _broadcastTimer = Timer(_currentInterval, _announceLoop);
  }
